                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    @can('prestadores_de_servicio_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.prestadores-de-servicios.index') }}">
                                    ...
                                    @can('municipio_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.municipios.index') }}">
                                            {{ trans('cruds.municipio.title') }}
                                        </a>
                                    @endcan
                                    @can('destino_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.destinos.index') }}">
                                            {{ trans('cruds.destino.title') }}
                                        </a>
                                    @endcan
                                    @can('idioma_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.idiomas.index') }}">
                                            {{ trans('cruds.idioma.title') }}
                                        </a>
                                    @endcan
                                    @can('divisa_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.divisas.index') }}">
                                            {{ trans('cruds.divisa.title') }}
                                        </a>
                                    @endcan
                                    @can('estatus_reserva_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.estatus-reservas.index') }}">
                                            {{ trans('cruds.estatusReserva.title') }}
                                        </a>
                                    @endcan
                                    @can('estatus_pago_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.estatus-pagos.index') }}">
                                    ...
                                    @can('detalle_de_reserva_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.detalle-de-reservas.index') }}">
                                            {{ trans('cruds.detalleDeReserva.title') }}
                                        </a>
                                    @endcan
                                    @can('pago_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.pagos.index') }}">
                                    ...
                                    @endcan
                                    @can('enlace_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.enlaces.index') }}">
                                            {{ trans('cruds.enlace.title') }}
                                        </a>
                                    @endcan
                                    @can('bloques_pagina_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.bloques-paginas.index') }}">
                                            {{ trans('cruds.bloquesPagina.title') }}
                                        </a>
                                    @endcan
                                    @can('admin_config_access')
                                        <a class="dropdown-item ml-3" href="{{ route('frontend.admin-configs.index') }}">
