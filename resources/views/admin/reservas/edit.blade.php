...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.reservas.update", [$reserva->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="nro_reserva">{{ trans('cruds.reserva.fields.nro_reserva') }}</label>
                <input class="form-control {{ $errors->has('nro_reserva') ? 'is-invalid' : '' }}" type="text" name="nro_reserva" id="nro_reserva" value="{{ old('nro_reserva', $reserva->nro_reserva) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('subtotal') ? 'is-invalid' : '' }}" type="number" name="subtotal" id="subtotal" value="{{ old('subtotal', $reserva->subtotal) }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total') ? 'is-invalid' : '' }}" type="number" name="total" id="total" value="{{ old('total', $reserva->total) }}" step="0.01">
                @if($errors->has('total'))
                    <div class="invalid-feedback">
                        {{ $errors->first('total') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('moneda') ? 'is-invalid' : '' }}" type="text" name="moneda" id="moneda" value="{{ old('moneda', $reserva->moneda) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tasa_de_cambio') ? 'is-invalid' : '' }}" type="number" name="tasa_de_cambio" id="tasa_de_cambio" value="{{ old('tasa_de_cambio', $reserva->tasa_de_cambio) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('fecha_reserva') ? 'is-invalid' : '' }}" type="text" name="fecha_reserva" id="fecha_reserva" value="{{ old('fecha_reserva', $reserva->fecha_reserva) }}" required>
