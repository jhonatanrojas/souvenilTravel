    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.municipios.update", [$municipio->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('codigo_municipio') ? 'is-invalid' : '' }}" type="text" name="codigo_municipio" id="codigo_municipio" value="{{ old('codigo_municipio', $municipio->codigo_municipio) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nombre') ? 'is-invalid' : '' }}" type="text" name="nombre" id="nombre" value="{{ old('nombre', $municipio->nombre) }}">
