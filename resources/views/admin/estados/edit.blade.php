    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.estados.update", [$estado->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('codigoestado') ? 'is-invalid' : '' }}" type="text" name="codigoestado" id="codigoestado" value="{{ old('codigoestado', $estado->codigoestado) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nombre') ? 'is-invalid' : '' }}" type="text" name="nombre" id="nombre" value="{{ old('nombre', $estado->nombre) }}">
