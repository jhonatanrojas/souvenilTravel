    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.products.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('prestador_servicios') ? 'is-invalid' : '' }}" name="prestador_servicios[]" id="prestador_servicios" multiple>
                    @foreach($prestador_servicios as $id => $prestador_servicio)
                        <option value="{{ $id }}" {{ in_array($id, old('prestador_servicios', [])) ? 'selected' : '' }}>{{ $prestador_servicio }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nro_adultos') ? 'is-invalid' : '' }}" type="number" name="nro_adultos" id="nro_adultos" value="{{ old('nro_adultos', '1') }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nro_ninos') ? 'is-invalid' : '' }}" type="number" name="nro_ninos" id="nro_ninos" value="{{ old('nro_ninos', '0') }}" step="1">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('destino') ? 'is-invalid' : '' }}" name="destino_id" id="destino_id">
                    @foreach($destinos as $id => $entry)
                        <option value="{{ $id }}" {{ old('destino_id') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('diponible_desde') ? 'is-invalid' : '' }}" type="text" name="diponible_desde" id="diponible_desde" value="{{ old('diponible_desde') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('disponible_hasta') ? 'is-invalid' : '' }}" type="text" name="disponible_hasta" id="disponible_hasta" value="{{ old('disponible_hasta') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('latitud') ? 'is-invalid' : '' }}" type="text" name="latitud" id="latitud" value="{{ old('latitud', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('logitud') ? 'is-invalid' : '' }}" type="text" name="logitud" id="logitud" value="{{ old('logitud', '') }}">
