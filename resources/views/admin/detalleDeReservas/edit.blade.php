...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.detalle-de-reservas.update", [$detalleDeReserva->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cant_adultos') ? 'is-invalid' : '' }}" type="number" name="cant_adultos" id="cant_adultos" value="{{ old('cant_adultos', $detalleDeReserva->cant_adultos) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cant_ninos') ? 'is-invalid' : '' }}" type="number" name="cant_ninos" id="cant_ninos" value="{{ old('cant_ninos', $detalleDeReserva->cant_ninos) }}" step="1">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('fecha_desde') ? 'is-invalid' : '' }}" type="text" name="fecha_desde" id="fecha_desde" value="{{ old('fecha_desde', $detalleDeReserva->fecha_desde) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('fecha_hasta') ? 'is-invalid' : '' }}" type="text" name="fecha_hasta" id="fecha_hasta" value="{{ old('fecha_hasta', $detalleDeReserva->fecha_hasta) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('moneda') ? 'is-invalid' : '' }}" type="text" name="moneda" id="moneda" value="{{ old('moneda', $detalleDeReserva->moneda) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tasa_de_cambio') ? 'is-invalid' : '' }}" type="number" name="tasa_de_cambio" id="tasa_de_cambio" value="{{ old('tasa_de_cambio', $detalleDeReserva->tasa_de_cambio) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('precio') ? 'is-invalid' : '' }}" type="number" name="precio" id="precio" value="{{ old('precio', $detalleDeReserva->precio) }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total') ? 'is-invalid' : '' }}" type="number" name="total" id="total" value="{{ old('total', $detalleDeReserva->total) }}" step="0.01" required>
                @if($errors->has('total'))
                    <div class="invalid-feedback">
                        {{ $errors->first('total') }}
                    </div>
