...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.idioma.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.idiomas.store") }}" enctype="multipart/form-data">
            @csrf
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('texto') ? 'is-invalid' : '' }}" type="text" name="texto" id="texto" value="{{ old('texto', '') }}" required>
                @if($errors->has('texto'))
                    <div class="invalid-feedback">
                        {{ $errors->first('texto') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('posicion') ? 'is-invalid' : '' }}" type="text" name="posicion" id="posicion" value="{{ old('posicion', '') }}">
