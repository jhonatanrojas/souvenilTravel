...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.idiomas.update", [$idioma->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label for="codigo">{{ trans('cruds.idioma.fields.codigo') }}</label>
                <input class="form-control {{ $errors->has('codigo') ? 'is-invalid' : '' }}" type="text" name="codigo" id="codigo" value="{{ old('codigo', $idioma->codigo) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('texto') ? 'is-invalid' : '' }}" type="text" name="texto" id="texto" value="{{ old('texto', $idioma->texto) }}" required>
                @if($errors->has('texto'))
                    <div class="invalid-feedback">
                        {{ $errors->first('texto') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('lang') ? 'is-invalid' : '' }}" type="text" name="lang" id="lang" value="{{ old('lang', $idioma->lang) }}">
                @if($errors->has('lang'))
                    <div class="invalid-feedback">
                        {{ $errors->first('lang') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('posicion') ? 'is-invalid' : '' }}" type="text" name="posicion" id="posicion" value="{{ old('posicion', $idioma->posicion) }}">
