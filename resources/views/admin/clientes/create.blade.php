    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.clientes.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('apellidos') ? 'is-invalid' : '' }}" type="text" name="apellidos" id="apellidos" value="{{ old('apellidos', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('cedula') ? 'is-invalid' : '' }}" type="text" name="cedula" id="cedula" value="{{ old('cedula', '') }}">
