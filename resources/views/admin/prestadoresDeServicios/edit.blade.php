...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.prestadoresDeServicio.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.prestadores-de-servicios.update", [$prestadoresDeServicio->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                <label class="required" for="nombre_razon_social">{{ trans('cruds.prestadoresDeServicio.fields.nombre_razon_social') }}</label>
                <input class="form-control {{ $errors->has('nombre_razon_social') ? 'is-invalid' : '' }}" type="text" name="nombre_razon_social" id="nombre_razon_social" value="{{ old('nombre_razon_social', $prestadoresDeServicio->nombre_razon_social) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('direccion') ? 'is-invalid' : '' }}" type="text" name="direccion" id="direccion" value="{{ old('direccion', $prestadoresDeServicio->direccion) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('telefono') ? 'is-invalid' : '' }}" type="text" name="telefono" id="telefono" value="{{ old('telefono', $prestadoresDeServicio->telefono) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('telefono_2') ? 'is-invalid' : '' }}" type="text" name="telefono_2" id="telefono_2" value="{{ old('telefono_2', $prestadoresDeServicio->telefono_2) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('nombre_representate') ? 'is-invalid' : '' }}" type="text" name="nombre_representate" id="nombre_representate" value="{{ old('nombre_representate', $prestadoresDeServicio->nombre_representate) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('email') ? 'is-invalid' : '' }}" type="email" name="email" id="email" value="{{ old('email', $prestadoresDeServicio->email) }}">
                @if($errors->has('email'))
                    <div class="invalid-feedback">
                        {{ $errors->first('email') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('password') ? 'is-invalid' : '' }}" type="text" name="password" id="password" value="{{ old('password', $prestadoresDeServicio->password) }}">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('estado') ? 'is-invalid' : '' }}" name="estado_id" id="estado_id">
                    @foreach($estados as $id => $entry)
                        <option value="{{ $id }}" {{ (old('estado_id') ? old('estado_id') : $prestadoresDeServicio->estado->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('municipio') ? 'is-invalid' : '' }}" name="municipio_id" id="municipio_id">
                    @foreach($municipios as $id => $entry)
                        <option value="{{ $id }}" {{ (old('municipio_id') ? old('municipio_id') : $prestadoresDeServicio->municipio->id ?? '') == $id ? 'selected' : '' }}>{{ $entry }}</option>
                    @endforeach
                </select>
