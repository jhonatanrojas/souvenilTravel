...
@can('prestadores_de_servicio_create')
    <div style="margin-bottom: 10px;" class="row">
        <div class="col-lg-12">
            <a class="btn btn-success" href="{{ route('admin.prestadores-de-servicios.create') }}">
                        ...
                        <tr data-entry-id="{{ $prestadoresDeServicio->id }}">
                            ...
                            <td>
                                @can('prestadores_de_servicio_show')
                                    <a class="btn btn-xs btn-primary" href="{{ route('admin.prestadores-de-servicios.show', $prestadoresDeServicio->id) }}">
                                        {{ trans('global.view') }}
                                    </a>
                                @endcan

                                @can('prestadores_de_servicio_edit')
                                    <a class="btn btn-xs btn-info" href="{{ route('admin.prestadores-de-servicios.edit', $prestadoresDeServicio->id) }}">
                                        {{ trans('global.edit') }}
                                    </a>
                                @endcan
