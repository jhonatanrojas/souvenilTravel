    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.pagos.update", [$pago->id]) }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('reserva') ? 'is-invalid' : '' }}" name="reserva_id" id="reserva_id">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('moneda') ? 'is-invalid' : '' }}" type="text" name="moneda" id="moneda" value="{{ old('moneda', $pago->moneda) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('tasa_de_cambio') ? 'is-invalid' : '' }}" type="number" name="tasa_de_cambio" id="tasa_de_cambio" value="{{ old('tasa_de_cambio', $pago->tasa_de_cambio) }}" step="0.01">
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('fecha_de_pago') ? 'is-invalid' : '' }}" type="text" name="fecha_de_pago" id="fecha_de_pago" value="{{ old('fecha_de_pago', $pago->fecha_de_pago) }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('forma_de_pago') ? 'is-invalid' : '' }}" type="text" name="forma_de_pago" id="forma_de_pago" value="{{ old('forma_de_pago', $pago->forma_de_pago) }}">
