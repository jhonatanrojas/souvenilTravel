    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.pagos.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('monto') ? 'is-invalid' : '' }}" type="number" name="monto" id="monto" value="{{ old('monto', '0') }}" step="0.01" required>
                @if($errors->has('monto'))
                    <div class="invalid-feedback">
                        {{ $errors->first('monto') }}
                    </div>
            ...
            <div class="form-group">
                ...
                <input class="form-control date {{ $errors->has('fecha_de_pago') ? 'is-invalid' : '' }}" type="text" name="fecha_de_pago" id="fecha_de_pago" value="{{ old('fecha_de_pago') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('forma_de_pago') ? 'is-invalid' : '' }}" type="text" name="forma_de_pago" id="forma_de_pago" value="{{ old('forma_de_pago', '') }}">
