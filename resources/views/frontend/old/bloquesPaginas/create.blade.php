    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.bloques-paginas.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="pagina" id="pagina" value="{{ old('pagina', '*') }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="conetenido" id="conetenido">{!! old('conetenido') !!}</textarea>
