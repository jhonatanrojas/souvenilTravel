                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.banners.update", [$banner->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="target" id="target" value="{{ old('target', $banner->target) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="titulo" id="titulo" value="{{ old('titulo', $banner->titulo) }}">
                        ...
                        <div class="form-group">
                            ...
                            <textarea class="form-control ckeditor" name="html" id="html">{!! old('html', $banner->html) !!}</textarea>
                            @if($errors->has('html'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('html') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="orden" id="orden" value="{{ old('orden', $banner->orden) }}" step="1">
                            @if($errors->has('orden'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('orden') }}
                                </div>
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="estatus" id="estatus" value="1" {{ $banner->estatus || old('estatus', 0) === 1 ? 'checked' : '' }}>
