    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.reservas.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="nro_reserva">{{ trans('cruds.reserva.fields.nro_reserva') }}</label>
                            <input class="form-control" type="text" name="nro_reserva" id="nro_reserva" value="{{ old('nro_reserva', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="subtotal" id="subtotal" value="{{ old('subtotal', '0') }}" step="0.01" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="moneda" id="moneda" value="{{ old('moneda', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="tasa_de_cambio" id="tasa_de_cambio" value="{{ old('tasa_de_cambio', '') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="fecha_reserva" id="fecha_reserva" value="{{ old('fecha_reserva') }}" required>
