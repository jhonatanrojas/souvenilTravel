    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.detalle-de-reservas.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="cant_adultos" id="cant_adultos" value="{{ old('cant_adultos', '1') }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="cant_ninos" id="cant_ninos" value="{{ old('cant_ninos', '0') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="fecha_desde" id="fecha_desde" value="{{ old('fecha_desde') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="fecha_hasta" id="fecha_hasta" value="{{ old('fecha_hasta') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="moneda" id="moneda" value="{{ old('moneda', 'USD') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="tasa_de_cambio" id="tasa_de_cambio" value="{{ old('tasa_de_cambio', '1') }}" step="0.01">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="precio" id="precio" value="{{ old('precio', '0') }}" step="0.01" required>
