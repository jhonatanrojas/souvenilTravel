                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.products.update", [$product->id]) }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="prestador_servicios[]" id="prestador_servicios" multiple>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="nro_adultos" id="nro_adultos" value="{{ old('nro_adultos', $product->nro_adultos) }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="nro_ninos" id="nro_ninos" value="{{ old('nro_ninos', $product->nro_ninos) }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" name="destino_id" id="destino_id">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="direccion" id="direccion" value="{{ old('direccion', $product->direccion) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="diponible_desde" id="diponible_desde" value="{{ old('diponible_desde', $product->diponible_desde) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="disponible_hasta" id="disponible_hasta" value="{{ old('disponible_hasta', $product->disponible_hasta) }}">
                        ...
                        <div class="form-group">
                            <div>
                                ...
                                <input type="checkbox" name="estatus" id="estatus" value="1" {{ $product->estatus || old('estatus', 0) === 1 ? 'checked' : '' }}>
                                <label for="estatus">{{ trans('cruds.product.fields.estatus') }}</label>
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="latitud" id="latitud" value="{{ old('latitud', $product->latitud) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="logitud" id="logitud" value="{{ old('logitud', $product->logitud) }}">
