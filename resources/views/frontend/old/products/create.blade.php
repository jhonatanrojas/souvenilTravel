                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.products.store") }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="nro_adultos" id="nro_adultos" value="{{ old('nro_adultos', '1') }}" step="1" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="nro_ninos" id="nro_ninos" value="{{ old('nro_ninos', '0') }}" step="1">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="diponible_desde" id="diponible_desde" value="{{ old('diponible_desde') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="disponible_hasta" id="disponible_hasta" value="{{ old('disponible_hasta') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="logitud" id="logitud" value="{{ old('logitud', '') }}">
