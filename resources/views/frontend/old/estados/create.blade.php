    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.estados.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            <label for="codigoestado">{{ trans('cruds.estado.fields.codigoestado') }}</label>
                            <input class="form-control" type="text" name="codigoestado" id="codigoestado" value="{{ old('codigoestado', '') }}">
