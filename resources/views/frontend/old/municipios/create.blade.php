    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.municipios.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="codigo_municipio">{{ trans('cruds.municipio.fields.codigo_municipio') }}</label>
                            <input class="form-control" type="text" name="codigo_municipio" id="codigo_municipio" value="{{ old('codigo_municipio', '') }}" required>
