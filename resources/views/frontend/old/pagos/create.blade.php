    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.pagos.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="number" name="monto" id="monto" value="{{ old('monto', '0') }}" step="0.01" required>
                            @if($errors->has('monto'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('monto') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control date" type="text" name="fecha_de_pago" id="fecha_de_pago" value="{{ old('fecha_de_pago') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="forma_de_pago" id="forma_de_pago" value="{{ old('forma_de_pago', '') }}">
