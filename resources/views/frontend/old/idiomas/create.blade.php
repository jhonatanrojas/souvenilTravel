    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.idiomas.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="texto" id="texto" value="{{ old('texto', '') }}" required>
                            @if($errors->has('texto'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('texto') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="posicion" id="posicion" value="{{ old('posicion', '') }}">
