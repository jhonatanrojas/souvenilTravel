    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.prestadores-de-servicios.update", [$prestadoresDeServicio->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="nombre_razon_social">{{ trans('cruds.prestadoresDeServicio.fields.nombre_razon_social') }}</label>
                            <input class="form-control" type="text" name="nombre_razon_social" id="nombre_razon_social" value="{{ old('nombre_razon_social', $prestadoresDeServicio->nombre_razon_social) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="direccion" id="direccion" value="{{ old('direccion', $prestadoresDeServicio->direccion) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="telefono" id="telefono" value="{{ old('telefono', $prestadoresDeServicio->telefono) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="telefono_2" id="telefono_2" value="{{ old('telefono_2', $prestadoresDeServicio->telefono_2) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="nombre_representate" id="nombre_representate" value="{{ old('nombre_representate', $prestadoresDeServicio->nombre_representate) }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="email" name="email" id="email" value="{{ old('email', $prestadoresDeServicio->email) }}">
                            @if($errors->has('email'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('email') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="password" id="password" value="{{ old('password', $prestadoresDeServicio->password) }}">
