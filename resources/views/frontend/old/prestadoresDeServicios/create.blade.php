    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.prestadores-de-servicios.store") }}" enctype="multipart/form-data">
                        @method('POST')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="nombre_razon_social">{{ trans('cruds.prestadoresDeServicio.fields.nombre_razon_social') }}</label>
                            <input class="form-control" type="text" name="nombre_razon_social" id="nombre_razon_social" value="{{ old('nombre_razon_social', '') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="telefono_2" id="telefono_2" value="{{ old('telefono_2', '') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="nombre_representate" id="nombre_representate" value="{{ old('nombre_representate', '') }}">
