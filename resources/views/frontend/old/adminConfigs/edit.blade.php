    ...
    <div class="row justify-content-center">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form method="POST" action="{{ route("frontend.admin-configs.update", [$adminConfig->id]) }}" enctype="multipart/form-data">
                        @method('PUT')
                        @csrf
                        <div class="form-group">
                            <label class="required" for="grupo">{{ trans('cruds.adminConfig.fields.grupo') }}</label>
                            <input class="form-control" type="text" name="grupo" id="grupo" value="{{ old('grupo', $adminConfig->grupo) }}" required>
                            @if($errors->has('grupo'))
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="codigo" id="codigo" value="{{ old('codigo', $adminConfig->codigo) }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="valor" id="valor" value="{{ old('valor', $adminConfig->valor) }}" required>
                            @if($errors->has('valor'))
                                <div class="invalid-feedback">
                                    {{ $errors->first('valor') }}
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" type="text" name="descripcion" id="descripcion" value="{{ old('descripcion', $adminConfig->descripcion) }}">
